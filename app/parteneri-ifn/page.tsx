...
const ifnList = [
  {
    key: "Hora Credit",
    title: "Hora Credit",
    tagline: "Credit rapid până la 5.000 lei, fără garanții",
    badge: "🎯 Fără garanții",
    badgeColor: "blue" as const,
    stars: 4,
    description:
      "Credit de nevoi personale fără garanții imobiliare, cu banii pe card în 30 de minute de la aprobare. Prima utilizare beneficiază de 0% dobândă timp de 7 zile.",
    table: {
      sumaMax: "5.000 lei",
      perioada: "până la 364 zile",
      venitMin: "Nu este obligatorie adeverință",
    ...
    drawbacks: [
      "Sumă maximă 5.000 lei",
      "Dobânzi specifice produselor IFN după perioada promoțională",
    ],
    ...
    bnrInfo: "HORA CREDIT IFN S.A. — Înregistrat BNR: RG-PJR-41-110313",
  },
  {
    key: "Via Conto",
    title: "Via Conto",
    tagline: "Linie de credit aprobată în 15 minute",
    badge: "⚡ Aprobare rapidă",
    badgeColor: "green" as const,
    stars: 4,
    description:
      "Linie de credit 100% online cu aprobare în aproximativ 15 minute. Utilizezi suma de care ai nevoie și plătești dobândă doar pe ce folosești. Potrivit atât pentru urgențe, cât și pentru cheltuieli planificate.",
    table: {
      sumaMax: "4.000 lei",
      perioada: "până la 12 luni",
      venitMin: "Nu este obligatorie adeverință",
      birouCredit: "Condiții flexibile",
    },
    benefits: [
      ...
      "Plătești doar ce utilizezi efectiv",
      "Linie refolosibilă după rambursare",
    ],
    drawbacks: [
      "Limită 1.000 lei la prima accesare (clienți noi)",
      "Dobânda standard de 1%/zi după perioada promoțională",
    ],
    ...
    bnrInfo: "VIA CONTO IFN S.A. — Înregistrat BNR: RG-PJR-41-110321",
  },
  {
    key: "CreditPrime",
    title: "CreditPrime",
