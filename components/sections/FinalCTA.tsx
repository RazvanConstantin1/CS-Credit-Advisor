...
export default function FinalCTA() {
  return (
    <section id="final-cta" className="bg-navy py-20 sm:py-28 relative overflow-hidden">
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background:
            "radial-gradient(ellipse 70% 70% at 50% 100%, rgba(26,58,42,0.6) 0%, transparent 70%)",
        }}
      />
        ...
        <div className="grid lg:grid-cols-[1fr_420px] gap-12 lg:gap-16 items-center">
          ...
          <FadeIn>
            ...
            <h2 className="font-playfair font-bold text-white text-[1.9rem] sm:text-[2.4rem] lg:text-[2.8rem] leading-[1.2] tracking-[-0.3px] mb-5">
              Creditul Tău<br />Te Așteaptă
            </h2>
            <p className="text-white/65 text-base leading-[1.75] mb-8">
              Nu lăsa situația financiară să te oprească. Indiferent de istoricul tău de credit,
              avem o soluție pentru tine — și totul este complet gratuit.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-5">
              {[
                ...
                <div key={s.label} className="text-center">
                  <span className="font-playfair font-bold text-gold text-xl block">{s.num}</span>
                  <span className="text-white/45 text-[11px] uppercase tracking-wider">{s.label}</span>
                </div>
              ))}
            </div>
          </FadeIn>
